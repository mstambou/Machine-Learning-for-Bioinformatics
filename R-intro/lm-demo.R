...
abline(coef=lm.fitted$coef, col="green") #fit a regular linear model with least squares error
abline(coef=rr.huber$coef, col="red")     #fit a robust regression, an alternative to least squares regression when data are contaminated with outliers or influential observations, and it can also be used for the purpose of detecting influential observations.
